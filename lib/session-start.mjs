 ...
 *
 * Hooks are always invoked via stdin pipe, so isTTY is always false.
 * Use TERM_PROGRAM to distinguish IDE-integrated usage from CLI.
 *
 * @returns {'claude-code'|'claude-cli'}
 */
function detectChannel() {
  const term = process.env.TERM_PROGRAM || '';
  // VS Code integrated terminal or Cursor
